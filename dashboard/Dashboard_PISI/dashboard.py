...
from layouts.experiment import create_experiment_layout
...
def render_page(tab):
    pages = {
        ...
        'experiment': create_experiment_layout,
    }

    page_factory = pages.get(tab, create_overview_layout)
    page_content = page_factory()

    # Páginas sem sidebar (base textual independente ou aba de experimento)
    if tab in {'pricing', 'shap', 'experiment'}:
        sidebar_style = {
            'display': 'none',
        }
    ...
    # Nas demais páginas, o CSS original controla a sidebar e o conteúdo.
    return page_content, {}, {}
...
experiment_cb.register_callbacks(app)
